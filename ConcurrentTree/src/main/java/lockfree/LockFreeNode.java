...
public class LockFreeNode<T extends Comparable>{
     ...
     */
    public class ChildNodes<T extends Comparable>{
    ...
    public LockFreeNode(T data, LockFreeNode leftChild, LockFreeNode rightChild)
    {
        this.data = data;
